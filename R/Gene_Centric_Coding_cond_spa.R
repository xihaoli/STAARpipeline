...
#'
#' The \code{Gene_Centric_Coding_cond_spa} function takes in chromosome, gene name, functional category,
...
#' imbalanced case-control phenotype and coding functional categories of a gene by using STAAR procedure.
#' For each coding functional category, the conditional STAAR-B p-value is a p-value from an omnibus test
...
#' @return a data frame containing the conditional STAAR p-values (including STAAR-B) corresponding to each coding functional category of the given gene.
